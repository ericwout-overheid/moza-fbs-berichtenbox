 ...
 */
data class Page<T>(
    @get:JsonProperty("results") val resultaten: List<T>,
    @get:JsonProperty("page") val pagina: Int,
    @get:JsonProperty("pageSize") val paginaGrootte: Int,
    @get:JsonProperty("totalPages") val totaalPaginas: Int,
    @get:JsonProperty("totalElements") val totaalElementen: Long
) {
    init {
